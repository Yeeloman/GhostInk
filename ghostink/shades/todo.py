...
class TodoItemModel(BaseModel):
    ...
    subtasks: Optional[List[TodoSubtask]] = None
    ...
    def dropper(self, entry_obj):
        ...
        try:
            ...
            for err in error_details:
                error_output.append(f'{err.get('loc')}: {err.get('msg')}\n')
        ...
        for item in entry_obj:
            ...
            entry.append(f'{self.TITLE_COLOR}{item['title']}{self.RESET} ({status_color}{status[0]}{self.RESET}/{priority_color}{priority[0]}{self.RESET})\n')
